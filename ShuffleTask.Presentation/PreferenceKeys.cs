...
internal static class PreferenceKeys
{
    ...
    public const string PomodoroTotal = "pref.pomodoro.total";
    public const string PomodoroFocus = "pref.pomodoro.focus";
    public const string PomodoroBreak = "pref.pomodoro.break";
}
